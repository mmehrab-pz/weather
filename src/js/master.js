...
function create_city_box() {
  ...
  const existingBox = cityBoxContainer.querySelector(
    `li[data-city="${currentCity.trim().toLowerCase()}"]`
  );
  ...
  box.innerHTML = `
        <div class="flex items-center">
            <figure class=" h-full">
                <img src="src/asset/img/icon/${currentDescription.toLowerCase()}.png" alt="">
            </figure>
            <div class=" ml-5">
...
function changeCity(s) {
  currentCity =
    s.firstElementChild.lastElementChild.firstElementChild.innerText;
  getData();
}
